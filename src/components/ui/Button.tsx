...
const variants: Record<Variant, string> = {
  primary:
    'bg-accent text-white hover:bg-accent-strong active:bg-accent-strong shadow-accent-glow disabled:shadow-none',
  ...
  success: 'bg-success text-base hover:brightness-110',
...
const sizes: Record<Size, string> = {
  ...
  xl: 'h-16 px-6 text-lg rounded-2xl gap-2.5 font-semibold',
};
